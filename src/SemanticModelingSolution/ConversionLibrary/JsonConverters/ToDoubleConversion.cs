...
{
    public class ToJsonNumberConversion : ConversionBase, IConversion
    {
        ...
        public ToJsonNumberConversion(ConversionContext conversionContext) : base(conversionContext) { }
