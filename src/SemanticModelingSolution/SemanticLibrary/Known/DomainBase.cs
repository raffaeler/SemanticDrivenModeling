...
namespace SemanticLibrary
{
    ...
    {
        public virtual List<TermToConcept> Links => new()
        {
            ...
            new TermToConcept(KnownBaseConcepts.Identity, KnownBaseConcepts.Any, KnownBaseConceptSpecifiers.None, KnownBaseTerms.Title, 80),
